...
<body>
	...
	<div class="maincon">
		<div class="container">
			...
			<form action="fbdeleteservlet" method="post">

				
				<label for="name">ID:</label> 
				<input type="text" value ="<%=id%>" id="id" name="id" required/> 
				...
				<label for="name">Name:</label>
				 <input type="text" value="<%=name%>" id="name"
					name="name" required />
					 ...
					 <input type="text" value="<%=event%>" id="event" name="event" required /> 
					
					 <label for="message">Feedback:</label> 
					
					<input type="text" value="<%=feedback%>" id="feedback" style="height: 100px;"  name="feedback" required /> 
					
					<label for="rating">Rating:(1-5)</label>
					
					 <input type="text" value="<%=rating%>" id="rating" name="rating" required />

				<div style="display: flex; justify-content: center">
					<button type="submit" style="margin-right: 20px">delete</button>
