	...
	<div class="maincon">
		<div class="container">
			...
			<p
				...
				<input type="text" value="<%=event%>"id="event" name="event" /> 
				
				<label for="message">Feedback:</label>
				<input type="text" style="height: 100px;" value="<%=feedback%>" name="feedback"  /> 
				
				<label for="rating">Rating::(very satisfy, good,not bad,bad)</label> 
				<input type="text" value="<%=rating%>" id="rating" name="rating"  />
