...
<style>
  body {
    margin: 0;
    padding: 0;
  	background-image: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(css/gallery1.jpg);
...
<div class="header">
	...
	<div class="topnav">
		<a href="#">Profile</a> <a href="#">Feedback</a> <a href="#">Link</a> <a
			href="packageaccount.jsp">packages</a> <a href="#">Home</a>
	</div>
...
<form action="PackageInsert" method="post">
    ...
    <input type="text" name="pname"><br>
      ...
      <label class="lform">Event type:</label><br><br>
