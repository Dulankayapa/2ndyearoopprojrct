...
h1 {
  ...
  text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.6); /* Multiple shadows */
}
...
<form action="UpdatePackageServlet" method="post">
    ...
    <input type="text" name="packagename" value="<%= name%>"><br>
    ...
    <input class="lform" type="submit" name="submit" value="Update package">
</form>
